              ...
              <Link
                ...
                className={`flex items-center gap-4 px-5 py-3.5 rounded-2xl transition-all duration-200 group font-medium active:scale-[0.98] ${
                  isActive
                    ...
                    : 'text-[var(--secondary-500)] hover:bg-[var(--muted)] hover:text-[var(--primary)] dark:hover:text-[var(--primary)] hover:translate-x-1'
                }`}
              >
                <Icon size={20} className={`transition-all duration-200 ${isActive ? 'text-[var(--primary)]' : 'text-[var(--secondary-400)] group-hover:text-[var(--primary)] group-hover:scale-110'}`} />
                <span>{label}</span>
              </Link>
            </li>
          ))}
